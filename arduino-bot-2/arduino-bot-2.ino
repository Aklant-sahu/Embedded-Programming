...
const int mindist=5,minerror=0,minerror2=3,minerror3=6,mindist1=4;
 int autospeed=60;
...
int pwmb1 = 6; //Back motor pinouts to pick balls from rack
int dirb1 = 29;
int pwmb2 = 4;
int dirb2 = 31;
int spb = 200;
...
void setup() {
TCCR4B = TCCR4B & B11111000 | B00000010;  // for PWM frequency of 3921.16 Hz    // set timer 5 divisor to     8 for PWM frequency of  3921.16 Hz
