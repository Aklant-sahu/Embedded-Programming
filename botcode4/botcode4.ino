...
int val1,val2,butval,in1,in2,in3,in4,a;
#include <PS3BT.h>
#include <usbhub.h>
  ...
  if (PS3.PS3Connected || PS3.PS3NavigationConnected) {
    ...
    if (val1 > 126) {
     ...
     digitalWrite(dir2,LOW);
      ...
      {
        Serial.print(F("\r\nDown"));
         digitalWrite(dir2,LOW);//Isme 2,3 mai kuch bhi dir do no farak caus they are off only
      digitalWrite(dir3,LOW);
       digitalWrite(dir1,HIGH);
      digitalWrite(dir4,HIGH);
      ...
      {
        Serial.print(F("\r\nLEFT"));
         digitalWrite(dir2,HIGH);//Isme 1,4 mai kuch bhi dir do no farak caus they are off only
      digitalWrite(dir3,HIGH);
       digitalWrite(dir1,HIGH);
      digitalWrite(dir4,HIGH);
