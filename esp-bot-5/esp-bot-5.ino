...
#define RXp2 16
#define TXp2 17
void send(int a,int b,int c,int d,int e,int f,int g,int h,int i,int j,int k,int l,int m,int n,int o,int p,int q,int r)
{
...
void loop()
{
 ...
 cro=(Ps3.data.button.cross);
 squ=(Ps3.data.button.square);
 tri=(Ps3.data.button.triangle);
 cir=(Ps3.data.button.circle);
...
//    Serial.print("\n");
send(lX,lY,rX,rY,cro,squ,tri,cir,upp,downn,leftt,rightt,ll1,ll2,rr1,rr2,start,select);
  }
